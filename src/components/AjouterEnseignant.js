...
const AjouterEnseignant = ({ onEnseignantAjoute, onRetour }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                'https://localhost/api/enseignants-permanents/ajouter',
                newEnseignant
            );
            ...
            setError(err.response?.data || 'Erreur lors de l\'ajout de l\'enseignant');
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6">
                <h2 className="text-2xl font-bold mb-6">Ajouter un enseignant permanent</h2>
